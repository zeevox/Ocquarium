...
APK_NAME_OCTO=`ls -1 app/build/outputs/apk/release/ | tr -d '\n'`

curl -F chat_id="-1001357118452" -F sticker="CAADBAAD8R8AAmSKPgABCOk3mg-Zvf0C" https://api.telegram.org/bot${BOT_TOKEN}/sendSticker
curl -F chat_id="-1001357118452" -F document=@"app/build/outputs/apk/release/${APK_NAME_OCTO}" https://api.telegram.org/bot${BOT_TOKEN}/sendDocument
